<%@ page contentType="text/html;charset=utf-8" %>
        ...
        <div class="container">
            ...
            <div class="related mar-t40">
                ...
                <div class="related-header">
                    <h2>相关教师/学生</h2>
                    <a class="more" href="/more-teacher.jsp" target="_blank">更多</a>
                </div>
                <div class="related-body" id="js-related">
                    <ul class="related-titles mar-t10">
                        <li>
                            <a href="/publish/shangqiu/syzx/teacher.jsp?id=3">马晓慧</a>
                        </li>
                        <li>
                            <a href="/publish/shangqiu/syzx/teacher.jsp?id=4">苏本启</a>
                        </li>
                        <li>
                            <a href="/publish/shangqiu/syzx/teacher.jsp?id=5">苏玮</a>
                        </li>
                        <li>
                            <a href="/publish/shangqiu/syzx/teacher.jsp?id=6">王艳峰</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        var g_id = qs.id;
        $.getJSON("/publish/shangqiu/syzx/json/teacher.json", function(data) {
