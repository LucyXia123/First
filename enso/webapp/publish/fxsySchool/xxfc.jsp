...
<html>
    <head>
        ...
        <meta name="keywords" content="同方,教育在线,同方凌讯">
    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li><a href="../../model-school.jsp?school=濮阳市范县思源学校">校园采风</a></li>        
            ...
            <div class="article">
                <div class="article-header" align="center">
                    ...
                    <div class="article-metas" >
                        <div style='margin:2px 10px 10px 30px;'>学校:范县思源学校
    ...
    <script>
        ...
        $(function () {
            ...
            for (var i = 0; i < imgs.length; i++) {
                imgsHtml += "<img height='400' width='400' style='margin:2px 10px 10px 2px;' src='" +
                        "./" +
