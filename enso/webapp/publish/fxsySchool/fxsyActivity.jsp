    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li class="active"><a href="javascript:;">活动风采</a></li>
            </ol>
            <div class="article">
                <div class="article-header">
                    <h1 class="t-c" id="js-title"></h1>
                    <div class="article-metas">
                        <div>学校:范县思源中学</div><span>|</span>           
    ...
    <script>
        ...
        $(function () {
            ...
            for (var i = 0; i < imgs.length; i++) {
                imgsHtml += "<img height='300' width='300' style='margin:2px 10px 10px 2px;' src='" +
                        "./" +
            ...
            //$("#js-img").attr("src", "../../publish/fxsySchool/" +  GetArgsFromHref(urlinfo, "model") + "/" + GetArgsFromHref(urlinfo, "name"));
        });
