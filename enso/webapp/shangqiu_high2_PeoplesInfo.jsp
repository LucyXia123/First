...
<html>
    ...
    <script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "GET",
                url: "./publish/shangqiu/high2/" + GetArgsFromHref(urlinfo, "model") + "/" + GetArgsFromHref(urlinfo, "info") + ".json",
                dataType: "json",
            ...
            $("#js-img").attr("src", "./publish/shangqiu/high2/" +
                    GetArgsFromHref(urlinfo, "model") + "/" + GetArgsFromHref(urlinfo, "name") + ".png");
        });
