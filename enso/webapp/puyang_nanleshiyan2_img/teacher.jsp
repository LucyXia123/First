    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li><a href="../model-school.jsp?school=濮阳市南乐县第二实验小学">教师/学生风采</a></li>        
            ...
            <div class="article">
                <div class="article-header">
                    ...
                    <div class="article-metas">
                        <div>学校: <span id="js-school">濮阳市南乐县第二实验小学</span></div><span>|</span>           
...
<!--        <div class="related mar-t40">
                ...
                <div class="related-body" id="js-related">
                    <ul class="related-titles mar-t10">
                        ...
                        <li><a href="teacher.jsp?id=3">郭振霞</a></li>
                        <li><a href="teacher.jsp?id=4">李秀丽</a></li>
                        <li><a href="teacher.jsp?id=5">李艳萍</a></li>
                        <li><a href="teacher.jsp?id=6">宋晓燕</a></li>
                    </ul>
                </div>
            </div>-->
        </div>
