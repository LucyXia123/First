...
<html>
    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li><a href="../model-school.jsp?school=濮阳市南乐县第二实验小学">校园风采</a></li>        
                <li class="active"><a href="javascript:;">校园一角</a></li>
            </ol>
            <div class="article">
                <div class="article-header">
                    <h1 class="t-c" id="js-title" style="text-align:center">校园一角</h1>
                    <div class="article-metas" style="text-align:center">
                        <div>学校: <span id="js-school">濮阳市南乐第二实验小学</span></div>
	...
	<img height="350" width="500" src="./schoolView/3.jpg" />
</div>
