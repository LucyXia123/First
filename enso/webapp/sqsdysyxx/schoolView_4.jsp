        ...
        <div class="container">
            ...
            <div class="article">
                ...
                <div class="article-body">
                    <div class="t-c">
                        <img class="pt" src="./schoolView/4.jpg" />
                    </div>
...
<!--            <div class="related mar-t40">
                ...
                <div class="related-body" id="js-related">
                    <ul class="related-titles mar-t10">
                        <li><a href="theme.jsp?id=1">传达学习党的十九大精神专题会议</a></li>
                        <li><a href="theme.jsp?id=2">加减乘除 演绎精彩无限</a></li>
                        <li><a href="theme.jsp?id=3">管弦乐团与艺术家同台交流演出</a></li>
                        <li><a href="theme.jsp?id=4">消防安全疏散演练活动</a></li>
                    </ul>
                </div>
            </div>-->
        </div>
