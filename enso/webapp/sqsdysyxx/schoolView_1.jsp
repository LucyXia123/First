        ...
        <div class="container">
            ...
            <div class="article">
                <div class="article-header">
                    <h1 class="t-c" id="js-title" style="text-align:center">校门</h1>
                    <div class="article-metas" style="text-align:center">
                        <div>学校: <span id="js-school">商丘市第一实验小学</span></div>
                        <span>|</span>
                        <div>日期: <span id="js-date">2017年12月12日</span></div>                           
                    </div>
                </div>
                <div class="article-body">
                    <div class="t-c">
                        <img class="pt" src="./schoolView/1.jpg" />
                    </div>
