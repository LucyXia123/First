    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li><a href="model-school.jsp?school=濮阳市南乐县育才小学">示范校</a></li>        
            ...
            <div class="article">
                <div class="article-header">
                    ...
                    <div class="article-metas">
                        ...
                        <span>|</span><div>日期: <span id="js-datetime">2017年09月29日 09:22</span></div>                           
                    </div>
                </div>
...
<!--            <div class="related mar-t40">
                ...
                <div class="related-body" id="js-related">
                    <ul class="related-titles mar-t10">
                        ...
                        <li><a href="nanleyucaiteacher.jsp?id=3">郭冬玲</a></li>
                        <li><a href="nanleyucaiteacher.jsp?id=4">韩若冰</a></li>
                        <li><a href="nanleyucaiteacher.jsp?id=5">李冰</a></li>
                        <li><a href="nanleyucaiteacher.jsp?id=6">骆蕤</a></li>
                    </ul>
                </div>
            </div>-->
        </div>    
