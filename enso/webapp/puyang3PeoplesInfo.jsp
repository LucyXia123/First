    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li><a href="model-school.jsp?school=濮阳市第三中学">示范校</a></li>        
            ...
            <div class="article">
                <div class="article-header">
                    ...
                    <div class="article-metas">
                        <div id="js-school">学校:濮阳市第三中学 </div><span>|</span>           
...
<!--            <div class="related mar-t40">
    ...
    <script>
        ...
        $(function () {
           ...
           $.ajax({
             type: "GET",
             url: "./publish/puyang3school/"+ GetArgsFromHref(urlinfo,"model")+"/"+GetArgsFromHref(urlinfo,"info")+".json",
             dataType: "json",
             success: function(data){
                  var content = "";
                 for(var i=0;i<data.contexts.length;i++){
//                     console.info(data.contexts[i]);
                     content +="<p>"+ data.contexts[i]+"</p>\n";
                 }
                
                 $("#js-content").html(content);
                 $("#js-title").text(data.name + "简介");
            $("#js-datetime").text(data.date);
             $("#js-img").attr("src","./publish/puyang3school/"+
                    GetArgsFromHref(urlinfo,"model")+"/"+data.name+".jpg");           
             }                
            });           
        });
