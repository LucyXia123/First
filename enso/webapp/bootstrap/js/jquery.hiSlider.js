!function(t) {
    ...
    i.prototype = {
        init: function() {
            ...
            this.size = this.$item.length ? this.$item.length : this.$item.size();
        ...
        movePrev: function(t) {
            ...
            1 !== t &&
            ("move" === i.options.mode ?
                0 === i.curIndex && (i.curIndex = i.size - 1, i.$container.css(i.getMove())) :
                0 === i.curIndex && (i.curIndex = i.size), i.curIndex--),
            i.options.isAuto && i.autoPlay(),
            i.setTitle(),
            i.setPages(),
        ...
        getMove: function(t) {
            ...
            return "top" == o ? (i.top = -this.curIndex * e.height,
            t && (i.width = e.width)) : (i.left = -this.curIndex * e.width,
            t && (i.height = e.height)),
            i
        },
        fade: function() {
            ...
            t.$item.fadeOut(t.options.affectTime).eq(t.curIndex).fadeIn(t.options.affectTime, function() {
                t.options.onMoveAfter.call(this, t.$item, t.curIndex)
            })
        },
        fadePrev: function(t) {
            var i = this;
            1 !== t && ("move" === i.options.mode ?
                0 === i.curIndex && (i.curIndex = i.size - 1, i.$container.css(i.getMove())) :
                0 === i.curIndex && (i.curIndex = i.size), i.curIndex--);
            i.options.isAuto && i.autoPlay();
            i.setTitle();
            i.setPages();
            i.options.onMoveBefore.call(i.$container, i.$item, i.curIndex);
            i.$item.fadeOut(i.options.affectTime).eq(i.curIndex).fadeIn(i.options.affectTime, function() {
                i.options.onMoveAfter.call(this, i.$item, i.curIndex)
            })
        },
        setPages: function() {
            if (this.options.isShowPage && this.$pages) {
                var i = this.curIndex;
                i == this.size - 1 && "move" == this.options.mode && (i = 0),
        ...
        setLayout: function() {
            ...
            this.options.isShowTitle && (this.$title = t('<div class="hiSlider-title"/>').insertAfter(this.$container),
            this.setTitle()),
            this.options.isShowPage && (this.$pages = t('<div class="hiSlider-pages">' + this.getPages() + "</div>").insertAfter(this.$container),
            this.pagesSwitch()),
            this.options.isShowControls && (this.$prev = t('<a href="javascript:;" class="hiSlider-btn-prev">prev</a>'),
            this.$next = t('<a href="javascript:;" class="hiSlider-btn-next">next</a>'),
            this.$container.after(this.$prev.add(this.$next)),
            this.controlsSwitch()),
            "move" == this.options.mode ? (this.$container.append(this.$item.eq(0).clone().addClass("item-clone")),
            this.$item = this.$container.find(this.options.item),
            this.size = this.$item.size()) : this.setFade(),
        ...
        getSetCss: function() {
            ...
            return "fade" === this.options.mode ?
                (t.position = "absolute", i.height = t.height, i.width = t.width) :
                ("top" === this.options.direction ? (i.height = 100 * (this.size + 1) + "%", i.width = t.width, i.top = -(e * t.height)) :
                    (i.height = t.height, i.width = 100 * (this.size + 1) + "%", i.left = -(e * t.width), t.float = "left"),
                    i.position = "relative"),
                {
                    item: t,
                    container: i,
        ...
        pagesSwitch: function() {
            if (this.options.isShowPage && this.$pages) {
                ...
                t("a", this.$pages).on("click", function() {
                    ...
                    // i[i.options.mode + "Prev"](!0);
                    i.curIndex--;   // t.fade()会前进一张图, i.curIndex++
                    i[i.options.mode]();
                })
            }
        },
        ...
        getSize: function() {
            ...
            if (this.options.isFullScreen) {
                ...
                e = this.$wrap ? this.$wrap.parent() : this.$container.parent();
