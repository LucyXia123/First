...
<div class="header">
  <div class="header-wrapper">
    <div class="crumb">
      ...
      <a class="has-next" href="model-school.jsp#名师优课">名师优课</a>
		...
		$.ajax({
			...
			if (data instanceof Array) {
				data.forEach(function(item, i) {
					...
					url = "video.jsp?videoId=" + item.id;			
				
					var $preview = $("<div>").addClass("item-preview");
					$preview.html("<a href=\""+url+"\" target=\"blank\"><img class=\"poster\" src=\""+item.poster+"\"></a>");
					$div.append($preview);
					...
					var html = "<h3 class=\"item-title\"><a href=\""+url+"\" target=\"blank\">"+item.name+"</a></h3>"+
