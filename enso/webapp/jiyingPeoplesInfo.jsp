...
<html>
            ...
            <!--            <div class="related mar-t40">
                            ...
                            <div class="related-body" id="js-related">
                                <ul class="related-titles mar-t10">
                                    <li><a href="jiyingPeoplesInfo.jsp?model=students&info=11&name=张予馨&date=2017-11-24">张予馨</a></li>
                                    <li><a href="jiyingPeoplesInfo.jsp?model=students&info=12&name=左宇烜&date=2017-11-23">左宇烜</a></li>
                                    <li><a href="jiyingPeoplesInfo.jsp?model=students&info=13&name=王姿诺&date=2017-11-24">王姿诺</a></li>
                                    <li><a href="jiyingPeoplesInfo.jsp?model=students&info=14&name=王昱苏&date=2017-11-24">王昱苏</a></li>
                                </ul>
                            </div>
                        </div>-->
        </div>    
    ...
    <script>
        ...
        $(function () {
            ...
            $.ajax({
                type: "GET",
                url: "./publish/jiying/" + GetArgsFromHref(urlinfo, "model") + "/" + GetArgsFromHref(urlinfo, "info") + ".json",
                dataType: "json",
                success: function (data) {
                    var content = "";
                    if (data.contexts instanceof Array) {
                        for (var i = 0; i < data.contexts.length; i++) {
                            content += data.contexts[i] + "\n";
                        }
                    } else {
                        content = data.contexts;
                    }
            ...
            $("#js-img").attr("src", "./publish/jiying/" +
