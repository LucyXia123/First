    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li class="active"><a href="javascript:;">办学</a></li>
            </ol>
            <div class="article">
                <div class="article-header">
                    <h1 class="t-c" id="js-title" style="text-align:center">办学</h1>
                ...
                <div class="article-body">
                    <div class="t-c">
                        <img height="350" width="500" src="./schoolView/bx-1.jpg" />
                        <img height="350" width="500" src="./schoolView/bx-2.jpg" />
                        <img height="350" width="500" src="./schoolView/bx-3.jpg" />
                        <img height="350" width="500" src="./schoolView/bx-4.jpg" />
                    </div>
