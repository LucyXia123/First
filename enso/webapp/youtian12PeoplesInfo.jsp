...
<html>
    ...
    <body id="news">
        ...
        <div class="container">
            <ol class="breadcrumb mar-t40">
                ...
                <li><a href="model-school.jsp?school=濮阳市油田第十二中学">教师/学生风采</a></li>
            ...
            <div class="article">
                <div class="article-header">
                    ...
                    <div class="article-metas">
                        <div>学校:濮阳市油田第十二中学</div><span>|</span>
    ...
    <script>
        ...
        $(function () {
           ...
           $.ajax({
             type: "GET",
             url: "./publish/youtian12/"+ GetArgsFromHref(urlinfo,"model")+"/"+GetArgsFromHref(urlinfo,"info")+".json",
             dataType: "json",
